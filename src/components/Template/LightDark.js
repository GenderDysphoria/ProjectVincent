    ...
    <>
      ...
      <light-dark>
        <Button component="label" color={null} className="theme--light">
          ...
          <SvgIcon viewBox="0 0 24 24" role="img" aria-label="Light Mode" size="md" className="icn--light">
        ...
        <Button component="label" color={null} className="theme--dark">
          ...
          <SvgIcon viewBox="0 0 24 24" role="img" aria-label="Dark Mode" size="md" className="icn--dark">
            <title>Dark Mode</title>
            <desc>An icon representing the moon</desc>
