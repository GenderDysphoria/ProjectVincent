...
<Gutter>
  <Card>
    ...
    />
    <Card.Content>
      Alle Steroide werden aus Cholesterinen gebildet (oben links) und leiten sich von anderen Steroiden ab. Gestagene wandeln sich zu Androgenen, welche sich wiederum zu Östrogenen formen. Dies ist eine Einbahnstraße. Es ist also falsch, wenn jemand sagt „zu viel Östrogen verwandelt sich in Testosteron“. Richtig ist: „zu viel Testosteron wandelt sich in Östrogen“.
...
<Gutter>
  <Card>
    <Card.Header>Zu Ihrer Information</Card.Header>
    <Card.Content>
