...
<Note>
  **Anmerkung des Kurators**: Der nachfolgender Text wurde [von Cassie LaBelle auf Medium veröffentlicht](https://aninjusticemag.com/am-i-trans-a-roadmap-to-figuring-out-the-toughest-question-7bb0e809a32d) und wird mit ihrer Erlaubnis übersetzt und hier geteilt. [Auf Medium können Sie mehr von Ihr lesen.](https://cassielabelle.medium.com/)
</Note>
...
<Gutter>
  <Card>
    <Card.Header>Warum ist die „Egg-Prime-Direktive“ nötig?</Card.Header>
    <Card.Content>
