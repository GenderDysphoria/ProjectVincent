import { Meta, Gutter, Image, Card, Tweet, FlexRow } from '#src/common';
...
<Card>
  ...
  />
  <Card.Content>
    Dies ist keine Science-Fiction, auch wenn es abgedroschen klingt
  </Card.Content>
</Card>
...
<Gutter>
  <Card>
    ...
    />
    <Card.Content>
      <a href="https://schoolbag.info/biology/concepts/188.html">Quelle</a>
    </Card.Content>
  </Card>
</Gutter>
...
<Gutter>
  <FlexRow center>Und es wird noch verrückter!</FlexRow>
  <Tweet unified no-reply>
    <Tweet id="1224039568971710464" />
    <Tweet id="1224040716365524993" />
    <Tweet id="1224041800513380352" />
    <Tweet id="1224042620164296705" />
    <Tweet id="1224043995413639168" />
    <Tweet id="1224044949160611840" />
  </Tweet>
</Gutter>
