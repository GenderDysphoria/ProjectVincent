import { Meta, Note, Gutter, Quote, Card, Image } from '#src/common';
...
<Gutter>
  <Quote>
    <dt>Cis-Gen·der</dt> - <em>Adjektiv</em><br />
    <dd>Aus lat. *cis-* „diesseits“. Bezeichnet Übereinstimmung von Geschlechtsidentität (Gender) und biologischem Geschlecht.</dd>
  </Quote>
</Gutter>
...
<Gutter>
  <Quote>
    <dt>Dys·pho·ri·e</dt> - <em>Substantiv, f</em><br />
    <dd>Ein Zustand des Unbehagens oder der allgemeinen Unzufriedenheit mit dem Leben. Das Gegenteil von Euphorie.</dd>
  </Quote>
  <Card>
    <Card.Media
      as={Image}
      src="/de/images/glue.jpg"
      alt=""
    />
  </Card>
</Gutter>
