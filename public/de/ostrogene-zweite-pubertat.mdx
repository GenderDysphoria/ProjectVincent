...
<Gutter>
  <Card>
    <Card.Media
      ...
      alt="Zwei rechte Hände nebeneinander. Die linke Hand ist vor dem Übergang und viel dicker als die rechte Hand."
    />
    <Card.Content>
...
<Gutter>
  <Card>
    <Card.Header>Anmerkung des Autors:</Card.Header>
    <Card.Content>
