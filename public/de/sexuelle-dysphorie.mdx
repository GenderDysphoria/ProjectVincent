import { Meta, Note, Gutter, Card, Tweet, Image } from '#src/common';
...
<Note>
  **Anmerkung des Autors**: Diese spezifische Art der sexuellen Dysphorie ist schwer verallgemeinerbar zu erklären, deshalb werde ich hier einen Abgang machen und aus meiner eigenen persönlichen Erfahrung darüber schreiben. Das Folgende wird aus meiner Sicht als binäre Transfrau dargestellt. Als solches ist dies möglicherweise nicht vollständig auf alle Trans-Personen zurückzuführen. Ich bitte um Entschuldigung.
</Note>
...
<Gutter>
  <Card>
    <Card.Media
      as={Image}
      src="/en/images/howbaby_swole.png"
      alt=""
      href="http://howbabycomic.com/comic/hb279/"
    />
    <Card.Content>
