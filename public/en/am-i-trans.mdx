...
<Note>
  **Curator's Note**: The following page comes from [a fantastic post written by Cassie LaBelle](https://aninjusticemag.com/am-i-trans-a-roadmap-to-figuring-out-the-toughest-question-7bb0e809a32d) and has been reshared with permission. [You can read more of her writing on Medium.](https://cassielabelle.medium.com/)
</Note>
...
<Gutter>
  <Card>
    <Card.Header>Why do we need The Egg Prime Directive?</Card.Header>
    <Card.Content>
