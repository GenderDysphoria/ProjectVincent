import { Quote, Meta, Image, Gutter, Card, Grid, Text } from '#src/common';
...
<Card>
  <Card.Content>
    <Text variant="muted">Title artwork based on creations by [Jumpei JP Ueoka](https://www.instagram.com/jp_means_jumpei/)</Text>
  </Card.Content>
  <Grid columns={2}>
