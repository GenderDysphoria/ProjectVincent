import { Gutter, Image, Card, TwitterEmbed, Tweet, Stack } from '#src/common';
...
export const meta = {
  ...
  description: "It's all about the hormones, baby.",
}
...
<Card>
  <Card.Media
    as={Image}
    src="/en/images/jurassicpark.jpg"
...
<Gutter>
  <Card>
    <Card.Media
      as={Image}
      src="/en/images/fetalgenitals.jpg"
      alt="Fetal development of internal sexual anatomy"
    />
    <Card.Content>
      <a href="https://schoolbag.info/biology/concepts/188.html">Source</a>
    </Card.Content>
  </Card>
</Gutter>
...
<Gutter>
  <Stack center>And it gets even weirder!</Stack>
  <TwitterEmbed oneblock>
      <Tweet
        id="1224039568971710464"
        href="https://twitter.com/LisaTMullin/status/1224039568971710464"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T18:39:09.000Z"
      >
        <Tweet.Body><p>Normally the Y chromosome carries 27 genes, only 4 are related to sex. One, the SRY, determines (via the SOX9 gene) whether testes or ovaries form in the early fetus. Another 3 determine sperm production if testes form.</p></Tweet.Body>
      </Tweet>
      <Tweet
        id="1224040716365524993"
        href="https://twitter.com/LisaTMullin/status/1224040716365524993"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T18:43:43.000Z"
      >
        <Tweet.Body><p>The SRY is just a signaler to 3 dark DNA areas to produce more SOX9 genes, above a certain threshold testes form, below that ovaries.</p><p>But that is just the start of the story. If ovaries form then another gene, FOXL2, keeps them as ovaries.</p></Tweet.Body>
      </Tweet>
      <Tweet
        id="1224041800513380352"
        href="https://twitter.com/LisaTMullin/status/1224041800513380352"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T18:48:01.000Z"
      >
        <Tweet.Body><p>FOXL2 works with estrogen receptors to keep the ovary as an ovary without which it would turn into testes and start producing testosterone by inhibiting SOX9 production.</p></Tweet.Body>
      </Tweet>
      <Tweet
        id="1224042620164296705"
        href="https://twitter.com/LisaTMullin/status/1224042620164296705"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T18:51:16.000Z"
      >
        <Tweet.Body><p>Male and female mammals produce SOX9  as far as I know all their lives (I need to check up on that) and even if there are already ovaries if the level becomes high enough then the ovaries will turn into testes.</p></Tweet.Body>
      </Tweet>
      <Tweet
        id="1224043995413639168"
        href="https://twitter.com/LisaTMullin/status/1224043995413639168"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T18:56:44.000Z"
      >
        <Tweet.Body><p>But FOXL2 production depends on enough estrogen and/or the estrogen receptors working correctly. If something goes wrong with either then SOX9 production increases and existing ovaries will turn into testes and produce testosterone.</p></Tweet.Body>
      </Tweet>
      <Tweet
        id="1224044949160611840"
        href="https://twitter.com/LisaTMullin/status/1224044949160611840"
        username="LisaTMullin"
        displayName="Lisa T Mullin"
        avatar="/twitter/avatars/LisaTMullin.jpg"
        date="2020-02-02T19:00:32.000Z"
      >
        <Tweet.Body><p>So there is a feedback loop: No SRY  means less SOX9, thus ovaries form. They produce estrogen which causes FOXL2 production which suppresses SOX9 production to keep the ovaries as ovaries. Is something goes wrong and SOX9 levels climb enough then those ovaries will become testes</p></Tweet.Body>
      </Tweet>
    </TwitterEmbed>
</Gutter>
