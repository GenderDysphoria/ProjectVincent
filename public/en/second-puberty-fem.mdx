import { Note, Gutter, Card, Image } from '#src/common';
...
<Gutter>
  <Card>
    <Card.Media>
      <Image
        src="/en/images/hands.jpeg"
        alt="Two right hands, side by side. The hand on the left is pre-transition and much thicker than the hand on the right."
      />
    </Card.Media>
    <Card.Content>
...
<Gutter>
  <Card>
    <Card.Header>Authors Note:</Card.Header>
    <Card.Content>
...
<Gutter>
  <Card>
    <Card.Header>Human Erogenous Zones:</Card.Header>
    <Card.Media>
      <Image
        src="/en/images/erogenous.png"
        alt="Image depicting a heatmap of human erogenous zones"
        href="https://www.researchgate.net/publication/301509880_Topography_of_Human_Erogenous_Zones#pf19"
      />
    </Card.Media>
    <Card.Content>
      Source: <a href="https://link.springer.com/article/10.1007/s10508-016-0745-z">Topography of Human Erogenous Zones</a>
    </Card.Content>
  </Card>
</Gutter>
