import { Note, Gutter, Card, TwitterEmbed, Tweet, Stack, Image, Quote } from '#src/common';
...
<Card>
  <Card.Header>Examples of some illustrations used to describe gender</Card.Header>
