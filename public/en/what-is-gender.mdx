import { Note, Gutter, Card, TwitterEmbed, Tweet, Stack, Image, Quote, Text } from '#src/common';
import Disclaimer from './_disclaimer.mdx';

export const meta = {
  key: 'genderwhat',
  title: "What is Gender?",
  linkTitle: "What is Gender?",
...
<Gutter>
  <Quote>
    <dt>Gen·der</dt> - <em>Noun</em><br />
    <dd>The range of characteristics pertaining to, and differentiating between, femininity and masculinity. Depending on the context, these characteristics may include biological sex, sex-based social structures (i.e., gender roles), or gender identity (the personal sense of one's own gender).</dd>
  </Quote>
</Gutter>
...
<Gutter>
  <TwitterEmbed>
    <Tweet
      id="1228717614630940672"
      href="https://twitter.com/CognitiveSoc/status/1228717614630940672"
      username="CognitiveSoc"
      displayName="Cog"
      avatar="/twitter/avatars/CognitiveSoc.jpg"
      date="2020-02-15T16:28:02.000Z"
    >
      <Tweet.Body>
        <p>Magnus Hirschfield was writing about Third Genders and transitioning between sex and gender in the late 1800s.</p>
        <p>This book of his, entitled "What do people need to know about the Third Gender?" was written in 1901.</p>
        <p>This stuff isn't new, it was just sidelined. </p>
      </Tweet.Body>
      <Tweet.Media type="image" src="/twitter/media/1228717614630940672/EQ1IKINWkAAllKR.jpg" poster="/tweets/1228717614630940672/EQ1IKINWkAAllKR.jpg?name=medium" />
    </Tweet>
    <Tweet
      id="1439225913623781377"
      href="https://twitter.com/Darkly_Dave/status/1439225913623781377"
      username="Darkly_Dave"
      displayName="Darkly Dai (Now with added werewolf)"
      avatar="/twitter/avatars/Darkly_Dave.jpg"
      date="2021-09-18T13:52:51.000Z"
    >
      <Tweet.Body>
        <p>When ever people try to say trans people are a recent phenomenon or trend I think of this photo from Magnus Hirschfield's institut für sexualwissenschaft (1919-1933 germany), that's him in the glasses with the big 'tache, everyone else in this photo is trans, it's from the 1920s. </p>
      </Tweet.Body>
      <Tweet.Media type="image" src="/twitter/media/1439225913623781377/E_knuCSVIAgyHYc.jpg" poster="/tweets/1439225913623781377/E_knuCSVIAgyHYc.jpg?name=medium" />
    </Tweet>
  </TwitterEmbed>
</Gutter>
...
<Card>
  <Card.Header>
    Examples of some illustrations used to describe gender
  </Card.Header>
  <Stack justify="around" align="center">
    <Image
      href
      src="/en/images/spectrum.jpg"
      hrefProps={{style: 'width:30%'}}
    />
    <Image
      href
      src="/en/images/graph.png"
      hrefProps={{style: 'width:30%'}}
    />
    <Image
      href
      src="/en/images/gender_unicorn.jpg"
      hrefProps={{style: 'width:30%'}}
    />
  </Stack>
  <Card.Content>
...
<Gutter>
  <Quote>
    <dt>Hab·i·tus</dt> - <em>Noun</em><br />
    <dd>Socially ingrained habits, skills, and dispositions. The way a person perceives and reacts to the world.</dd>
  </Quote>
</Gutter>
