...
<Gutter>
  <Card>
    <Card.Media
      as={Image}
      src="/en/images/steroidogenesis.svg"
      alt="Chart of steroid metabolism flow"
    />
    <Card.Content>
      All steroids are formed from cholesterols (top left) and are derived from other steroids. Progestins form into Androgens which form into Estrogens. This is a one-way exchange, and does not reverse, so don't believe it when someone tells you that too much estrogen will turn it into testosterone.
