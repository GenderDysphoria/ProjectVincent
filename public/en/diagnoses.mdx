...
<Gutter printInline>
  <Card>
    ...
    <Card.Content>
      Diagnosis of Gender Dysphoria in prepubescent children (in the United States) requires the child must have a documented six month history of meeting six of these criteria, as well as demonstrated distress or impairment in function.
